...
class ProductosActivity : AppCompatActivity() {
    ...
    fun agregarProducto(option:String?){
        when(option){
            "Antojitos"->{
                menu.add(Product("Quesadilla", R.drawable.quesadillas, "Rellenas con su carne favorita, servidas con ensalada - Filled with your choise meat, served with salad.", 5.99))
            ...
            "Especialidades"->{
                ...
                menu.add(Product("Botana Camarones", R.drawable.botanacamarones, "", 19.99))
                menu.add(Product("Coctel", R.drawable.coctel, "", 0.0))
                }
            "Combinations"->{
                ...
                menu.add(Product("Los Portales Pepe", R.drawable.burritopepe, "Large flour tortilla filled with grilled cactus, steak, pastor (seasoned pork), grilled onions, rice and beans. Served with a side of lettuce salad, tomatoes, sour cream and guacamole.", 9.99))
                menu.add(Product("Los Portales Burrito", R.drawable.burritosportales, "Large flour tortilla filled with grilled cactus, steak, pastor (seasoned pork), grilled onions, rice and beans. Served with a side of lettuce salad, tomatoes, sour cream and guacamole.", 13.99))
            ...
            "Drinks"->{
                menu.add(Product("Soda", R.drawable.sodas, "", 2.99))
                menu.add(Product("Jarritos", R.drawable.jarritos, "", 2.79))
                menu.add(Product("Caguama", R.drawable.caguama, "", 0.0))
                menu.add(Product("Caguama Michelada", R.drawable.caguamamichelada, "", 0.0))
                menu.add(Product("Charolazo", R.drawable.charolazo, "", 0.0))
                menu.add(Product("Cubeta Six", R.drawable.cubetasix, "", 0.0))
                menu.add(Product("Cubetazo", R.drawable.cubetazo, "", 0.0))
                menu.add(Product("Domestic Beer", R.drawable.domesticbeer, "", 0.0))
                menu.add(Product("Mexican Beer", R.drawable.mexicanbeer, "", 0.0))
                menu.add(Product("Michelada", R.drawable.michelada, "", 0.0))
                }
        }
    }
